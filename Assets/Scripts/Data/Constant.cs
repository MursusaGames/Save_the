...
{
    public const string DEVELOPER_URL = "https://play.google.com/store/apps/dev?id=5432149960976309187";
    public const string SOUND = "Sound";
    public const string MUSIC = "Music";
    public const string VIBRO = "Vibro";

    public const string GAMESTAGE = "StagE_01";
    public const string TECHNOSTAGE = "Stage_11";
    public const string FORESTSTAGE = "Stage_22";
    public const string FERMSTAGE = "StagE_051";
    ...
    public const string APPLE_1_DATA = "Apple_001";
